...
export default function (playerInstance, options)
{
    ...
    {
        const vpaidNonLinearSlot = document.getElementsByClassName('ww_vpaidNonLinear_ad')[0];
        ...
        vpaidNonLinearSlot.className      = 'ww_vpaid_slot';
        vpaidNonLinearSlot.id             = playerInstance.videoPlayerId + '_ww_vpaid_slot';
    ...
    playerInstance.hardStopVpaidAd = (deleteOtherVpaidAdsApart) =>
    {
        ...
        const vpaidIframes        = document.getElementsByClassName('ww_vpaid_iframe');
        const vpaidSlots          = document.getElementsByClassName('ww_vpaid_slot');
        const vpaidNonLinearSlots = document.getElementsByClassName('ww_vpaidNonLinear_ad');
    ...
    playerInstance.loadVpaid = (adListId, vpaidJsUrl) =>
    {
        ...
        vpaidIframe.id        = playerInstance.videoPlayerId + '_' + adListId + '_ww_vpaid_iframe';
        vpaidIframe.className = 'ww_vpaid_iframe';
    ...
    playerInstance.onVpaidEnded = (event) =>
    {
        ...
        const vpaidSlot = document.getElementById(playerInstance.videoPlayerId + '_ww_vpaid_slot');
