...
export default function (playerInstance, options)
{
    ...
    playerInstance.recalculateAdDimensions = () =>
    {
        ...
        const requestFullscreenFunctionNames = playerInstance.checkFullscreenSupport('ww_video_wrapper_' + playerInstance.videoPlayerId);
        const fullscreenButton               = document.getElementById(playerInstance.videoPlayerId + '_ww_control_fullscreen');
        ...
        else
        {
            ...
            const fullscreenTag = document.getElementById('ww_video_wrapper_' + playerInstance.videoPlayerId);
    ...
    playerInstance.setVastList = () =>
    {
        ...
        const validateVastList = function (item, addItem?: any)
        {
            let hasError = false;
