export default function (playerInstance, options)
{
    ...
    {
        const vrJoystickPanel = document.getElementById(playerInstance.videoPlayerId + '_ww_vr_joystick_panel');
        const joystickButton  = document.createElement('div');

        joystickButton.id        = playerInstance.videoPlayerId + '_ww_vr_joystick_' + identity;
        joystickButton.className = 'ww_vr_button ww_vr_joystick_' + identity;
    ...
    {
        const vrContainer = document.getElementById(playerInstance.videoPlayerId + '_ww_vr_container');

        // Create a JoyStick and append to VR container
        const vrJoystickPanel     = document.createElement('div');
        vrJoystickPanel.id        = playerInstance.videoPlayerId + '_ww_vr_joystick_panel';
        vrJoystickPanel.className = 'ww_vr_joystick_panel';
    ...
    {
        const vrJoystickPanel = document.getElementById(playerInstance.videoPlayerId + '_ww_vr_joystick_panel');
        const controlBar      = document.getElementById(playerInstance.videoPlayerId + '_ww_controls_container');
        ...
        const newControlBar = videoPlayerTag.parentNode.getElementsByClassName('ww_vr2_controls_container')[0];
        ...
        controlBar.classList.remove('ww_vr_controls_container');

        // show volume control bar
        const volumeContainer         = document.getElementById(playerInstance.videoPlayerId + '_ww_control_volume_container');
    ...
    {
        const vrJoystickPanel = document.getElementById(playerInstance.videoPlayerId + '_ww_vr_joystick_panel');
        const initialPlay     = document.getElementById(playerInstance.videoPlayerId + '_ww_initial_play');
        const volumeContainer = document.getElementById(playerInstance.videoPlayerId + '_ww_control_volume_container');
        ...
        if (initialPlay)
        {
            document.getElementById(playerInstance.videoPlayerId + '_ww_initial_play').style.display        = 'none';
            document.getElementById(playerInstance.videoPlayerId + '_ww_initial_play_button').style.opacity = '1';
        }
    ...
    {
        const controlBar = document.getElementById(playerInstance.videoPlayerId + '_ww_controls_container') as HTMLElement;

        // create and append dual control bar
        const newControlBar = controlBar.cloneNode(true) as HTMLElement;
        ...
        newControlBar.classList.add('ww_vr2_controls_container');
    ...
    playerInstance.cardBoardSwitchToVR = () =>
    {
        ...
        controlBar.classList.add('ww_vr_controls_container');
    ...
    {
        const timePlaceholder = document.getElementById(playerInstance.videoPlayerId + '_ww_control_duration');
        const controlBar      = document.getElementById(playerInstance.videoPlayerId + '_ww_controls_container');
        ...
        playerInstance.controlDurationUpdate = function ()
        {
            ...
            const timePlaceholder = playerInstance.domRef.player.parentNode.getElementsByClassName('ww_control_duration');
    ...
    playerInstance.createCardboardView = () =>
    {
        ...
        vrContainer.id        = playerInstance.videoPlayerId + '_ww_vr_container';
        vrContainer.className = 'ww_vr_container';
        ...
        playerInstance.trackEvent(playerInstance.domRef.player.parentNode, 'click', '.ww_control_cardboard', function ()
        {
    ...
    playerInstance.createCardboard = () =>
    {
        ...
        document
            .getElementById(playerInstance.videoPlayerId + '_ww_control_cardboard')
            .style
