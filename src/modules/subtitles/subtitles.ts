export default function (playerInstance, options)
{
    ...
    playerInstance.createSubtitlesSwitch = () =>
    {
        ...
        if (!playerInstance.displayOptions.layoutControls.subtitlesEnabled)
        {
            ...
            document.getElementById(playerInstance.videoPlayerId + '_ww_control_subtitles').style.display = 'none';
            return;
        }
        ...
        const subtitlesChangeButton         = document.getElementById(playerInstance.videoPlayerId + '_ww_control_subtitles');
        ...
        subtitlesChangeList.id            = playerInstance.videoPlayerId + '_ww_control_subtitles_list';
        subtitlesChangeList.className     = 'ww_subtitles_list';
        ...
        playerInstance.subtitlesTracks.forEach(function (subtitle)
        {
            ...
            subtitlesChangeDiv.className = 'ww_subtitle_list_item';
            ...
            subtitlesChangeDiv.addEventListener('click', function (event)
            {
                ...
                (subtitleChangedTo.firstChild as HTMLElement).className += ' subtitle_selected';
    ...
    playerInstance.renderSubtitles = () =>
    {
        ...
        let subtitlesContainer = document.getElementById(playerInstance.videoPlayerId + '_ww_subtitles_container');
    ...
    playerInstance.openCloseSubtitlesSwitch = () =>
    {
        const subtitleChangeList = document.getElementById(playerInstance.videoPlayerId + '_ww_control_subtitles_list');
    ...
    playerInstance.createSubtitles = () =>
    {
        ...
        divSubtitlesContainer.id        = playerInstance.videoPlayerId + '_ww_subtitles_container';
        divSubtitlesContainer.className = 'ww_subtitles_container';
        ...
        {
            (window as any).WebVTT = it.WebVTT;
            playerInstance.createSubtitlesSwitch();
        });
    };
}
